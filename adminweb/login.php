	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form action="log-member.php" class="login100-form validate-form flex-sb flex-w" method="post">
					<span class="login100-form-title p-b-32">
						<? if($_GET[salah]=='salah'){
		  echo"
		 <p class='login100-form-title p-b-32'>
                    Maaf Login Salah !!
                </p>";
		}else{
		  echo"<p class='login100-form-title p-b-32'>
